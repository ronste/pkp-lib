...
define('SUBMISSION_LOG_CHECKLIST_ACCEPTED',			0x10000008);
define('SUBMISSION_LOG_COPYRIGHT_ACCEPTED',			0x10000009);
define('SUBMISSION_LOG_PRIVACY_ACCEPTED',		0x100000010);
define('SUBMISSION_LOG_SUBMITTING_USER',        0x100000011);
